...
class PDFCanvas(Canvas):
    ...
    def __init__(self, res, cardw, cardh, outfile, pagesize, margin=(0,0),
            background=False, note=None, guides=(128, 128, 128),
            separators=(255, 255, 255), sepwidth=1, dpi=300, compat=False, **kwargs):
    ...
    def drawRect(self, x=0, y=0, width=None, height=0, stroke=None, fill=None, *args, **kwargs):
        ...
        self.canvas.rect(tomm(x), tomm(y), tomm(width), tomm(height), fill=fill and 1 or 0, stroke=stroke and 1 or 0)
